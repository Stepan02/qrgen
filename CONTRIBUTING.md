...
### Bug reporting
Did you find a bug?
- **Ensure the bug has not already been reported** - search for it in the [Issues section](https://www.github.com/Stepan02/qrgen/issues).
...
3. [Create a PR](https://github.com/Stepan02/qrgen/pulls) targeting the `main` branch
4. Make sure your contribution passes the CodeQL analysis and linting (ESLint/Stylelint) - these checks are automatic
